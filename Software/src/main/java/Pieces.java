...
public abstract class Pieces extends Application {
    ...
    public static void aled(Stage primaryStage) {
        ...
        Menu(primaryStage, GridPaneMenu);
        ...
        VBox hbox = new VBox(GridPaneMenu, root);
    ...
    static Image Menu(Stage primaryStage, GridPane test) {
        ...
        menu.getItems().addAll(menuItem2, menuItem3, menuItem1);
